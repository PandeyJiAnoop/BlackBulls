package com.akp.blackbulls.NewLoginJanuary;
...
import com.akp.blackbulls.Basic.SignupScreen;
...
public class JanuaryLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_january_login);
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("true")) {
                        ...
                        for (int i = 0; i < Response.length(); i++) {
                            ...
                            Toast.makeText(JanuaryLogin.this, "Verify Your OTP!", Toast.LENGTH_SHORT).show();
