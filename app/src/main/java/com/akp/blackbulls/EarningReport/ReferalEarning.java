...
public class ReferalEarning extends AppCompatActivity {
    ImageView back_img;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_referal_earning);
        ...
        srl_refresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                if (NetworkConnectionHelper.isOnline(ReferalEarning.this)) {
                    ...
                    Toast.makeText(ReferalEarning.this, "Please check your internet connection! try again...", Toast.LENGTH_SHORT).show();
                }
            }
        });
...
//        }
    ...
    public void GetPostionList() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppUrls.baseUrl+"DirectIncomeReport", new  Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    GridLayoutManager gridLayoutManager = new GridLayoutManager(ReferalEarning.this, 1);
                    PositionrAdapter HistoryAdapte = new PositionrAdapter(ReferalEarning.this, arrayList);
                    chat_recyclerView.setLayoutManager(gridLayoutManager);
                    chat_recyclerView.setAdapter(HistoryAdapte);
                } catch (JSONException e) {
                    Toast.makeText(ReferalEarning.this, "No Record Found!", Toast.LENGTH_SHORT).show();
                    e.printStackTrace();
                }
            }
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(ReferalEarning.this);
...
//        AnimationHelper.animatate(context,vh.itemView,R.anim.alfa_animation);
        ...
        public class VH extends RecyclerView.ViewHolder {
            TextView date_tv, amount_tv,name;
